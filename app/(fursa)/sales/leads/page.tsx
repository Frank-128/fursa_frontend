...
import { BiCheck, BiCross, BiSearch } from 'react-icons/bi';
import { Dialog, DialogBody, DialogHeader, Input, Radio } from '@material-tailwind/react';
...
export default function Leads() {
    ...
    useEffect(() => {
            ...
            setCustomers(getCustomers(leads));
            setLoading(false);
    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-between w-full">
                <Button type="button" icon={<MdOutlineFilterAltOff />} label="Clear" className='bg-[#ff8427] text-white focus:ring-0 p-2 hover:bg-white hover:text-[#ff8427] hover:shadow-xl hover:border-[0.8px] hover:border-gray-800' onClick={clearFilter} />
                <IconField iconPosition="left">
                    <InputIcon className={<BiSearch/>} />
                    <InputText value={globalFilterValue} className='p-2 border-[#17255a] border focus:ring-1 focus:ring-[#17255a]/20' onChange={onGlobalFilterChange} placeholder="Keyword Search" />
                </IconField>
            </div>
        );
    };
    ...
    const filterClearTemplate = (options) => {
        return <Button type="button" icon={<BiCross/>} onClick={options.filterClearCallback} severity="secondary"></Button>;
    };

    const filterApplyTemplate = (options) => {
        return <Button type="button" icon={<BiCheck/>} onClick={options.filterApplyCallback} severity="success"></Button>;
    };
    ...
    return (
      <div className='flex flex-col gap-2'>
        ...
        <Link href="/sales/leads/create" className='bg-[#17255a] p-2 transition duration-200 ease-in-out rounded text-[#ff8427] hover:text-[#17255a] hover:bg-[#ff8427]' onClick={()=>setOpenDialog(true)}>+ Add new lead</Link>
        </div>
        
        <div className="p-2 border-gray-600 border-[0.5px]">
            <DataTable value={customers} paginator showGridlines rows={10} loading={loading} dataKey="id" 
                    ...
                    emptyMessage="No Leads yet." onFilter={(e) => setFilters(e.filters)}>
